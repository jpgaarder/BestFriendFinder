...
module.exports = function (app) {
    // The app.get (GET route) request handles when user 'visits' a page. This will be used to display a JSON of all possible friends. //
    app.get("/api/friends", function (req, res) {
        res.json(friends);
    });
    // The app.post (POST route) request handles when a user submits a form and thus submits data to the server. //
    app.post("/api/friends", function (req, res) {
        ...
        // Loop through the friends data array of objects to get each friend scores //
        ...
        // The res.json method will return a JSON data with the user's match which was looped through friends data array //
        res.json(bestMatch);
    });
};